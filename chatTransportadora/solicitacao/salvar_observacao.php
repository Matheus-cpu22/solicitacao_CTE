...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Solicitação concluída!'); window.location.href='visualizar.php';</script>";
    } else {
        echo "<script>alert('Erro ao salvar.'); window.location.href='visualizar.php';</script>";
    }
